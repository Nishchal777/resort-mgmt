        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <small class="mx-2">Contact #</small>
                    <input type="text" name="contact" class="form-control form-control-sm form-control-border" placeholder="9#########" required>
                    
                </div>
                <div class="col-md-6">
                <small class="mx-2">Email</small>
                    <input type="email" name="email" class="form-control form-control-sm form-control-border" placeholder="email" required>
